...
class HomeContent extends React.Component {
  ...
  // we loop over the category ids from this.props.videosByCategory and
  //  create a VideoGrid component for each category
  getVideoGridsForCategories() {
    ...
    return categoryTitles.map((categoryTitle,index) => {
      ...
      //the last video grid should not have a divider
