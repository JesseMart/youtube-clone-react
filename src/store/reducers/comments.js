...
//                      SELECTORS
// ====================================================================
// This helper function returns the comment ids for a particular video if any
...
// this helper function uses the getSearchParam to extract the video id
// from the URL, then itll search for the object inside out state & 
// then we return the object nextPageToken
